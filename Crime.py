...
class Crime:
    def __init__(self,root):
       ...
       text = 'CRIME DETAIL:')
        ...
        self.buttonSaveData =  Button(OperationFrame, text = "Crime", bg='blue', font=('arial', 18, 'bold'), height = 1, width=10,bd=4)
        self.buttonSaveData.grid(row=1,column=0)
        
        self.buttonShowData =  Button(OperationFrame, text = "Station", bg='blue', font=('arial', 18, 'bold'), height = 1, width=10,bd=4)
        self.buttonShowData.grid(row=1,column=1)
        
        self.buttonClear =  Button(OperationFrame, text = "A", bg='blue', font=('arial', 18, 'bold'), height = 1, width=10,bd=4)
        self.buttonClear.grid(row=1,column=4)
        
        self.buttonDelete =  Button(OperationFrame, text = "B", bg='blue', font=('arial', 18, 'bold'), height = 1, width=10,bd=4)
        self.buttonDelete.grid(row=1,column=5)
        
        self.buttonSearch =  Button(OperationFrame, text = "C", bg='blue', font=('arial', 18, 'bold'), height = 1, width=10,bd=4)
        self.buttonSearch.grid(row=1,column=2)
        
        self.buttonUpdate =  Button(OperationFrame, text = "D", bg='blue', font=('arial', 18, 'bold'), height = 1, width=10,bd=4)
        self.buttonUpdate.grid(row=1,column=3)
        
        self.buttonClose =  Button(OperationFrame, text = "E", bg='blue', font=('arial', 18, 'bold'), height = 1, width=10,bd=4)
